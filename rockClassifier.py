...
def main():
	...
	print("Country count is : " + str(country_count))
	print("Electronic count is : " + str(electronic_count))
	print("Folk count is : " + str(folk_count))
	print("Hip-Hop count is: " + str(hiphop_count))
	print("Indie count is : " + str(indie_count))
	print("Jazz count is : " + str(jazz_count))
	print("Metal count is : " + str(metal_count))
	print("Pop count is : " + str(pop_count))
	print("R&B count is : " + str(rb_count))
